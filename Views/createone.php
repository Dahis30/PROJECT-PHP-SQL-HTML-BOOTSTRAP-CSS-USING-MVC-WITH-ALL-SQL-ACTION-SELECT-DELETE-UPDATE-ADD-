...
<body>
    <h1 class="text-muted">AJOUTER UN ELEMENT</h1><br>
    <form action="crateELT.php" method="post">
        <div class="form-group">
            <label for="exampleInputEmail1">Code</label>
            <input class="form-control" name="Code" type="text"><br>
            ...
            <button class="btn btn-primary" name="AJOUTEREL" type="submit">AJOUTER</button>
            <br>
        </div>
    </form>
    <br>
